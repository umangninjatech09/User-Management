...
DATABASES = {
    'default': {
        ...
        'NAME': 'user_management_db',   # database name
        'USER': 'postgres',             # default superuser
        'PASSWORD': '12345678', # password you set during install
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
AUTH_USER_MODEL = 'management.CustomUser'EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
