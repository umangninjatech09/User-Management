...
- Created custom user model with OTP and verification fields.
- Implemented user registration with OTP email verification.
- Developed login functionality with JWT authentication.
- Built password reset feature.
- Created Profile model with soft delete functionality.
- learned about logging in django.
"""