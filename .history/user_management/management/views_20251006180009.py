...
- Implemented user registration, login with JWT authentication, and OTP verification.
- Created models for User, Project, Leaves, and WorkTiming with soft delete functionality.
- Developed API views for CRUD operations on users, projects, leaves, and work timings.
- Used Django REST Framework for serialization and request handling.
- Configured email backend to send OTPs for user verification.
- Ensured secure password handling and user authentication.
- Added permissions to restrict access to certain endpoints.
- Tested all endpoints using Postman to ensure functionality.
-
'''