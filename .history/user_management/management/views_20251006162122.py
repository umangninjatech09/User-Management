...
from .models import Profile, Project, Leaves, WorkTiming
from .serializers import ProfileSerializer, ProjectSerializer, LeavesSerializer, WorkTimingSerializer, UserSignupSerializer, OTPRequestSerializer, OTPVerifySerializer
...
class RequestOTPView(APIView):
    def post(self, request):
        ...
        # In production, send via SMS/email. Here, returned for demo
