...
from .views import , VerifyOTPView, SimpleResetPasswordView, LoginView, ProfileListCreateView, ProfileDetailView, ProjectListCreateView, LeavesListCreateView, WorkTimingListCreateView
