...
from .views import RegisterView, VerifyOTPView, SimpleResetPasswordView, LoginView, ProfileListCreateView, ProfileDetailView, ProjectListCreateView, LeavesListCreateView
