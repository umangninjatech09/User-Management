...
- Implemented user signup, OTP-based authentication, and JWT token generation.
- Created models for Projects, Leaves, and Work Timings with CRUD operations.
- Ensured soft deletion for Projects and Leaves.-
- Used Django REST Framework for API development and serialization.
- Added permissions to secure endpoints.
- Optimized database queries with select_related and prefetch_related.
- Wrote unit tests for all views and models.
'''