...
class UserSignupSerializer(serializers.ModelSerializer):
    ...
    # Existing validation logic (case-insensitive uniqueness check)
    def validate_email(self, value):
        # ... (Your existing case-insensitive validation logic goes here) ...
        ...
        return value # Return the original value for now, normalization happens in .to_internal_value
    
    # 💡 NEW METHOD: Normalize the email to lowercase before saving to the database
    def to_internal_value(self, data):
        # Call the parent method to run standard validation and conversion first
        internal_value = super().to_internal_value(data)
        
        # Check if 'email' is present in the data being submitted
